 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query ExportCollections($cursor: String) {\n  collections(first: 250, after: $cursor) {\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    nodes {\n      id\n      title\n      handle\n      descriptionHtml\n      sortOrder\n      templateSuffix\n      image {\n        url\n        altText\n      }\n      ruleSet {\n        appliedDisjunctively\n        rules {\n          column\n          relation\n          condition\n        }\n      }\n    }\n  }\n}\n\nquery CollectionProducts($id: ID!, $cursor: String) {\n  collection(id: $id) {\n    products(first: 250, after: $cursor) {\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n      nodes {\n        handle\n      }\n    }\n  }\n}"): (typeof documents)["query ExportCollections($cursor: String) {\n  collections(first: 250, after: $cursor) {\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    nodes {\n      id\n      title\n      handle\n      descriptionHtml\n      sortOrder\n      templateSuffix\n      image {\n        url\n        altText\n      }\n      ruleSet {\n        appliedDisjunctively\n        rules {\n          column\n          relation\n          condition\n        }\n      }\n    }\n  }\n}\n\nquery CollectionProducts($id: ID!, $cursor: String) {\n  collection(id: $id) {\n    products(first: 250, after: $cursor) {\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n      nodes {\n        handle\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query ExportProducts($cursor: String) {\n  products(first: 250, after: $cursor) {\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    nodes {\n      id\n      title\n      handle\n      descriptionHtml\n      productType\n      vendor\n      status\n      tags\n      options {\n        name\n        values\n      }\n      variants(first: 100) {\n        nodes {\n          id\n          title\n          sku\n          barcode\n          price\n          compareAtPrice\n          inventoryPolicy\n          inventoryItem {\n            tracked\n            measurement {\n              weight {\n                unit\n                value\n              }\n            }\n          }\n          selectedOptions {\n            name\n            value\n          }\n          position\n        }\n      }\n      images(first: 20) {\n        nodes {\n          id\n          url\n          altText\n          width\n          height\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query ExportProducts($cursor: String) {\n  products(first: 250, after: $cursor) {\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    nodes {\n      id\n      title\n      handle\n      descriptionHtml\n      productType\n      vendor\n      status\n      tags\n      options {\n        name\n        values\n      }\n      variants(first: 100) {\n        nodes {\n          id\n          title\n          sku\n          barcode\n          price\n          compareAtPrice\n          inventoryPolicy\n          inventoryItem {\n            tracked\n            measurement {\n              weight {\n                unit\n                value\n              }\n            }\n          }\n          selectedOptions {\n            name\n            value\n          }\n          position\n        }\n      }\n      images(first: 20) {\n        nodes {\n          id\n          url\n          altText\n          width\n          height\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
